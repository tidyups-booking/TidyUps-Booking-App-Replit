...
import { useGetStaffMe, getGetBookingQueryKey } from '@workspace/api-client-react';
...
export default function JobDetailScreen() {
  ...
  // straight to this screen right after switching accounts), the shared guard
  // purges /staff/me AND the ID-keyed booking entry the moment the Clerk
  // userId changes, and we keep both queries disabled + masked until the
  // purge has run.
  const { userId, userChanged } = useAccountSwitchGuard([
    getGetBookingQueryKey(bookingId),
  ]);
